...
class TkInterEx:
	...
	def __init__(self, root):
		...
		open_img = Image.open("open.png").resize((32,32), Image.ANTIALIAS)
		save_img = Image.open("save.png").resize((32,32), Image.ANTIALIAS)
		exit_img = Image.open("exit.png").resize((32,32), Image.ANTIALIAS)
